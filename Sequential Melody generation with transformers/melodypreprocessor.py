...
class MelodyPreprocessor:
    ...
    def __init__(self, dataset_path, batch_size=32):
        ...
        # self.text_vectorizer = TextVectorization(output_mode="int", vocabulary=[], seperators=",")
    ...
    def _tokenize_and_encode_melodies(self, melodies):
        ...
        # self.text_vectorizer.adapt(melodies)
        # encoded_melodies = self.text_vectorizer(melodies)
